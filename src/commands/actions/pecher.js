...
module.exports = {
  ...
  data: new SlashCommandBuilder()
    .setName('pecher')
    .setDescription('Pêcher quelqu\'un')
  ...
  async execute(interaction) {
    ...
    const actionConfig = config?.actions?.commands?.['pecher'] || { enabled: true, rewardMin: 5, rewardMax: 15, karmaMin: 1, karmaMax: 3, messages: [] };
